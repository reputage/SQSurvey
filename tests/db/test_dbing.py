...
#     assert dbing.SQSurveyDB is env
#
#
...
#     dbing.setupDbEnv(DB_DIR_PATH)
#
#     dbHistory = dbing.SQSurveyDB.open_db(dbing.DB_KEY_HISTORY_NAME)
#
#     with dbing.SQSurveyDB.begin(db=dbHistory, write=True) as txn:
...
#     dbing.setupDbEnv(DB_DIR_PATH)
#
#     dbOtpBlob = dbing.SQSurveyDB.open_db(dbing.DB_OTP_BLOB_NAME)
#
#     with dbing.SQSurveyDB.begin(db=dbOtpBlob, write=True) as txn:
